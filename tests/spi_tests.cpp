...
TEST_GROUP(rf24_cmds)
{
	...
	void setup()
	{
		...
		pnrf24->csn = u_mock_ops.mock_csn;
		pnrf24->ce = u_mock_ops.mock_ce;
		pnrf24->delay_ms = u_mock_ops.mock_delay_ms;
		pnrf24->delay_us = u_mock_ops.mock_delay_us;
		pnrf24->spi_xfer = u_mock_ops.mock_spi_xfer_sbyte;
		pnrf24->spi_multi_xfer = u_mock_ops.mock_spi_xfer_mbyte;
